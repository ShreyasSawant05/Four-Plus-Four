...
export default function TimelineItem({
  ...
  return (
    <div
      onClick={onClick}
      className="flex flex-row items-center gap-2 md:gap-4 cursor-pointer group select-none relative z-10 py-1.5 w-auto md:w-full transition-all duration-300"
    >
      {/* Badge Ring/Circle */}
      <div className="relative w-10 h-10 md:w-12 md:h-12 flex items-center justify-center flex-shrink-0">
        ...
        <motion.div
          className={`
            w-8 h-8 md:w-10 md:h-10 rounded-full flex items-center justify-center font-display text-xs md:text-sm font-semibold border-2 transition-all duration-300
            ${isActive 
