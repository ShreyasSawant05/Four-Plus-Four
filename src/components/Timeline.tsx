...
function MobileTimeline() {
  ...
  return (
    <div className="relative px-4 py-8 bg-ivory block md:hidden overflow-hidden">
      {/* Connecting Vertical Line on Left */}
      <div className="absolute left-[33px] sm:left-[35px] top-12 bottom-12 w-[1.5px] bg-[#DF972B]/40 z-0" />
        ...
        {stepsData.map((item) => (
          ...
          >
            ...
            <div className="flex items-center gap-3">
              {/* Number Circle Node */}
              <div
                className={`w-9 h-9 rounded-full flex items-center justify-center font-display text-xs font-bold shadow-sm z-10 ${
                  item.num === '01'
                    ? 'bg-amber-gold text-burgundy border-2 border-amber-gold'
                    : 'bg-[#FFFBEA] border-2 border-[#DF972B]/35 text-burgundy/70'
                }`}
              >
                {item.num}
              </div>
              {/* Step Title Next to Node */}
              <span className="font-display font-bold text-xs tracking-widest text-burgundy uppercase">
                {item.title}
              </span>
            </div>
            ...
            <div className="pl-11">
              <div className="bg-[#FFFDF4]/95 border border-[#DF972B]/25 rounded-3xl p-5 shadow-soft">
                {/* Header inside card */}
                ...
                <div className="w-8 h-[2px] bg-amber-gold/60 my-2" />
...
export default function Timeline() {
  ...
  return (
    <>
      {/* Mobile View: Clean Vertical Timeline matching reference layout */}
      <MobileTimeline />
